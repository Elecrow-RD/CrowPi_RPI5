...
def remote():
    ...
    while g_exit is not True:
        ...
        i = 0
        if GPIO.input(remote_object.pin) == 0:
            count = 0
            while GPIO.input(remote_object.pin) == 0 and count < 200:
                count += 1
                time.sleep(0.00006)
            
            count = 0
            while GPIO.input(remote_object.pin) == 1 and count < 80:
                count += 1
                time.sleep(0.00006)
            idx = 0
            cnt = 0
            ...
            for i in range(0,32):
                count = 0
                while GPIO.input(remote_object.pin) == 0 and count < 15:
                    count += 1
                    time.sleep(0.00006)

                count = 0
                while GPIO.input(remote_object.pin) == 1 and count < 40:
                    count += 1
                    time.sleep(0.00006)
...
def sound():
    ...
    while g_exit is not True:
        ...
        while(GPIO.input(sound_pin)==GPIO.LOW):
            i = 1
