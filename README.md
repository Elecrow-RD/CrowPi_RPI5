# CrowPi
The 'QA.py' 'IR.py' 'MFRC522.py' are Crowpi PCBA test script.These files can be ignored.
...
Install the lirc library and the python driver to support our custom python script
````
